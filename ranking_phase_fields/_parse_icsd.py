...
#       #check if the elements / cations are right:
    ...
    print("==============================================")
    return fields, dictionary if return_dic else fields
...
if __name__ == "__main__":
    ...
    plt.hist(dic.values(), 100)
    plt.xlabel('Number of compositions within a phase field', fontsize=14)
    plt.ylabel("Number of M-M'-A-A' phase fields", fontsize=14)
    plt.show()
