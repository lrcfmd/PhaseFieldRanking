...
testing = generate_test(params['phase_fields'], params['nanions_train'], \
        params['cation1_test'], params['cation2_test'], params['anion1_test'], params['anion2_test'], training)
...
print(f"This represents each phase field with {numatoms(params['phase_fields'])} x {len(params['features'])}  = {numatoms(params['phase_fields'])*len(params['features'])} - dimensional vector")
print("==============================================")
...
rank(params['phase_fields'], training, testing, params['method'], len(params['features']), \
        numatoms(params['phase_fields']), params['average_runs'], params['scaling'])
